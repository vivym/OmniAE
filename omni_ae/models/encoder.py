...
class Encoder(nn.Module):
    ...
    Args:
        ...
        down_block_types (`Tuple[str, ...]`, *optional*, defaults to `("SpatialDownBlock3D",)`):
            The types of down blocks to use. See `~omni_ae.models.down_blocks.get_down_block` for available options.
        ...
        mid_block_type (`str`, *optional*, defaults to `"MidBlock3D"`):
            The type of mid block to use. See `~omni_ae.models.mid_blocks.get_mid_block` for available options.
